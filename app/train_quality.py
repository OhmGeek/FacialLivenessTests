...
def main():
    ...
    dataset = ReplayAttackDataset(logging.getLogger("c.o.datasets.replayattackdevel"),
                                  "/home/ryan/datasets/replayAttackDB/")
    dataset.pre_process()
    ...
    dataset = ReplayAttackDataset(logging.getLogger("c.o.datasets.replayattacktest"),
                                  "/home/ryan/datasets/replayAttackDB/", mode='test')
    dataset.pre_process()
