...
\section{Related Work}
    ...
    \subsection{2D Spoofing Attacks}
        ...
        results. One of the initial models was AlexNet, which has 5 convolutional layers (with some max pooling layers), and two globally connected layers.
        ...
        newer methods have been built that performed better. The VGG16 model improved AlexNet by replacing larger filters by more smaller filters one after another.
        ...
        due to high time and space requirements. Therefore, GoogLeNet Inception is an improved module that approximates a space Convolutional Network with a normal
