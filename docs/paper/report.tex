...
\paragraph{Method}
    Design, train and test three different innovative liveness tests.
    ...
    Using these liveness tests, an LDA based classifier was then trained to fuse the results of the above metrics together, to improve accuracy and allow for future expansion with further
    liveness tests.
...
\paragraph{Results}
    \begin{itemize}
        ...
        \item The LDA-based consolidation layer performed reasonably, but requires more liveness tests be included before the accuracy in production can be assertained.
    \end{itemize}
...
\section{Solution}
    ...
    of devices it can be used by can be maximized. Furthermore, each liveness test must have a reasonable accuracy of over 70\%, to ensure that liveness predictions are fairly reliable.
