...
\section{Related Work}
    ...
    \subsection{2D Spoofing Attacks}
        ...
        These different models include:
            ...
            With a low number of parameters, AlexNet is fairly easily deployed (since fewer computation resources are required). 
            ...
            Comparatively, this model has reduced computational requirements compared to VGG, while increasing prediction accuracy. \cite{DeepNeuralNetworkDeployability} Therefore, this is more suitable for a real-time system.
