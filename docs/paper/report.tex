...
\paragraph{Method}
    ...
    The first test developed was the Whole Image Quality Assessment (W-IQA) liveness test. This analysed image quality across the entire image, using
    ...
    The second test developed was the Convolutional Neural Network (CNN) based 2D liveness test. This model used a CNN-based face extraction process to obtain the input face, before feeding this through a ResNet50 based model to classify whether a specific face was real or spoofed.
