...
\section{Results}
    ...
    \subsection{Image Quality Liveness Test}
        ...
        and therefore future speed optimisations could consider optimising the calculation of the metrics.
    ...
    \subsection{2D Convolutional Neural Network Liveness Test}
        ...
        the time taken to predict a single image is very small, on average taking 1.04 seconds, which is even smaller than the W-IQA test, and almost half the specified 2 second time, which is ideal.        
